...
**Ссылка на страницу с пользователем в блоке "Отзывы пользователей" не ведёт на страницу с информацией о пользователе**

![feedback](/pictures/feedback.png "Отзывы")
...
![error_pavel](/pictures/error_user.png "Павел")


**Ссылка "далее" в блоке "Отзывы пользователей" не ведёт к страницу с отдельным полным отзывом пользователя**
...
![feedback](/pictures/all_feedback.png "Все отзывы")


**Ссылка на RSS, открытая в браузере Chrome, не отображается как лента новостей**

![rss](/pictures/rss.png "RSS")
...
![rss_text]{/pictures/rss_text.png "Текст RSS")


**Данные больше 15 символов не отображаются полностью в поле для поиска**

![search_field](/pictures/search_field.png "Поле поиска")
...
![error_search](/pictures/error_search.png "Данные в поле")


**Значок лупы в поле поиска заходит на текст поля**
...
**Страница не очень адаптирована под мобильные устройства**
...
![course_mobile](/pictures/course_mobile.jpeg "Страница на телефоне")
![course_small](/pictures/course_small.jpeg "Уменьшить масштаб")
![course_content](/pictures/course_content.jpeg "Содержание")
![course_content2]{/pictures/course_content2.jpeg "Содержание")

**Футер не отображается полностью на мобильном устройстве**
...
![footer_mobile](/pictures/footer_mobile.jpeg "Футер") 

![footer_mobile2](pictures/footer_mobile2.jpeg "Футер полностью")
...
![selected_links](/pictures/selected_links.png "Выбранные ссылки")
![all_feedback](/pictures/all_feedback.png "Все отзывы")
...
![video](/pictures/video.png "Видео")
...
Кнопки кликабельны и ведут на страницы с информацией о размещении резюме, корпоративном обучении, заявке на обучениеи контаками.


### Кнопка "Заказать звонок"

![call](/pictures/call.png)
...
![social](/pictures/social.png "Социальные кнопки")
